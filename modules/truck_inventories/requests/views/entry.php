 <section class="main-sec">
     <div class="container cont-sm">
         <div class="container-header pb8 flex align-center justify-between">
             ...
             <div>
                 <a href="truck_inventories-requests/new_form" class="button btn-primary">New Request</a>
             </div>
         </div>
         <div>
             <?php
                     ...
                     <div>
                         <?php
                            if ($item->sent == 1 && $item->fulfilled == 0) {
                             ...
                             <a href="truck_inventories-requests/show/<?= out($item->id) ?>" class="flex-inline pr8 no-decoration text-primary">
