...
class Mailman extends Trongate {
    ...
    */
    ...
    function _send_my_email($data){
        $sucess_redirect = $data['success_redirect'];
        ...
        $mail->Port = 465;
        $mail->SMTPAuth = true;
        $mail->Username = 'support@sesportal.us';
        $mail->Password = 'Platesfunnysadtherefore2024??';
        $mail->setFrom('support@sesportal.us', 'support');  
        ...
        //json($mail, true);
        if ($mail->send()) {
               redirect($sucess_redirect);
            } else {
                echo 'Mailer Error: ' . $mail->Debugoutput = 'error_log';            
                redirect('mailman/error_from_send_my_email');
        }       

    }
    function error_from_send_my_email(){   
        $this->view('error_from_send_my_email');
    }
