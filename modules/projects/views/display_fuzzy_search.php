<section class="main-sec">
    <div class="container w-500">
        <div class="container-header pb8 flex align-center justify-between">
            <div>
                <h2><?= $heading ?></h2>
                <p class="small-text text-secondary"></p>
            </div>
            <div>
                <a class="flex align-center button btn-secondary" href="projects/search_fuzzy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div class="m8-block pt16 pb16">
            <?php
            echo '<h3 >Total of ' . $total_job_hours . ' hours</h3>';
    ...
    <div class="searched-names">
        ...
        foreach ($job_names as $jname => $occurrence) { ?>
            <div class="names-list">
                <a href="projects/submit_search/<?= urlencode($jname) ?>/<?= $link_start_date ?>/<?= $link_end_date ?>" class="search-btn flex m8-block"><?= $jname ?> (<?= $occurrence ?>)</a>
